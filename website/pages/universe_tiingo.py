...
| **下载 Ticker 总数** | 21,384（NYSE / NASDAQ / AMEX 全量历史 Ticker）；成功下载 15,275 个，6,109 个因 Tiingo 无数据跳过 |
...
**为什么不需要再加？**
- 下载源头已覆盖全量美股，没有系统性遗漏
- 6,109 个 Tiingo 无数据的 Ticker 基本是场外（OTC/Pink Sheet）小票或纯权证，流动性极差，不适合趋势跟踪
- 1,490 个不足 252 天的标的生命周期太短，无法形成完整趋势，合理排除
