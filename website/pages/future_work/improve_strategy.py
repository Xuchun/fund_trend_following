...
|:-----:|------|------------|:-----:|:-----:|:-------:|:-------:|:-------:|
| 🔴 **最高** | **入场条件** | **金字塔加仓**；Gap 改为 ATR 基准 | ✅ 提升 | ✅ 提升 | **+4–5%** | 升高 1–2% | ★★★ 高 |
| 🔴 **高** | **止损** | 止损执行价改为 min(stop, open[t+1]) | 中性 | ✅ **最高** | -0.74pp | 中性 | ★ 低 |
| 🔴 **高** | **平价保护** | 浮盈达 1R 时止损移至略高于开仓价（净盈 ≈ +$1） | 中性 | 中性 | 中性 (+0.02pp) | ✅ **−1.1pp** | ★ 低 |
...
| 🟡 中等 | 执行假设 | 分层滑点；止损执行价（同止损节） | ✅ 提升 | ✅ 提升 | 中性 | 中性 | ★ 低 |
