...
| 🟡 中等 | 标的过滤 | ADV门槛通胀动态调整 | ✅ 提升 | 中性 | +0.5–1% | 中性 | ★★ 中 |
| 🟡 中等 | 市场环境过滤 | 增加 Choppiness Index 二层过滤 | ✅ 提升 | 中性 | 中性 | ✅ 降低 | ★★ 中 |
| 🟡 中等 | 成交量过滤 | Walk-Forward 验证 1.5× 阈值 | ✅ 提升 | 中性 | 中性 | 中性 | ★★ 中 |
| 🟡 中等 | 仓位管理 | 热度上限 heat_limit 降至 8% | 中性 | 中性 | -0.3% | ✅ 降低 | ★ 低 |
| 🟡 中等 | **Cluster Risk** | 相关性过滤升级为组合集中度上限 | 中性 | 中性 | 中性 | ✅ 降低 | ★★ 中 |
| 🟡 中等 | **时间止损** | N 日无进展则主动退出 | 中性 | 中性 | ✅ 提升 | ✅ 降低 | ★★ 中 |
