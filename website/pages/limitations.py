...
频繁小幅回调被快速修复，策略大量时间处于空仓或持有保守仓位状态。

**影响量级：** 量化宽松牛市每年跑输 SPY 约 4–5%，持续 10 年复利下来差距显著。
这不是策略设计缺陷，而是趋势跟踪类策略的内在特征——在极端市场（崩盘、泡沫破裂）
获取超额收益，在温和牛市中支付溢价。
...
| # | 局限性 | 严重程度 | 影响方向 | 量化估计 |
|---|-------|---------|---------|---------|
| 1 | **牛市持续跑输大盘** | 🔴 高 | 偏保守（实际可能更差） | 量化宽松10年每年少赚约 4–5% vs SPY |
| 2 | **OOS 2022 亏损** | 🟡 中 | 隐藏环境风险 | 加息熊市单年 OOS −9.1% |
...
（互联网泡沫、GFC、2022 加息均跑赢 SPY 超过 10%），但牛市跑输是核心代价。
