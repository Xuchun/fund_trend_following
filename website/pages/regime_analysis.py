...
| 加息熊市 | 2022-01 | 2022-12 | S&P500 于 **2022-01-03** 见顶；美联储全年激进加息 |
...
| 环境 | 策略1.0表现 | vs SPY |
|------|----------|--------|
| 互联网泡沫崩溃 | ✅ 极强 | 大幅跑赢（+5.2% vs −15.5%） |
| 熊市后复苏 | ✅ 强 | 跑赢（+16.4% vs +11.4%） |
| 金融危机 | 🟡 抗跌 | 跑赢（损失远少于 SPY） |
| QE驱动慢牛 | 🔴 落后 | 跑输约 6.6%（牛市代价） |
| COVID崩盘+复苏 | ✅ 极强 | 回撤控制优于 SPY |
| 加息熊市 | 🟡 抗跌 | 小幅跑赢但仍亏损 |
| AI驱动牛市 | 🟡 可接受 | 跑输但绝对收益可观 |
