...
| AI驱动牛市 | 2023-01 | {meta.backtest_end[:7]} | ChatGPT 引爆 AI 主题；延伸至回测结束日 **{meta.backtest_end}** |
""")
st.markdown("---")
...
| 市场环境 | 区间 | 特征 |
|----------|------|------|
| 互联网泡沫崩溃 | 2000-03 → 2002-10 | S&P500 顶部到底部，纳斯达克跌幅 −78% |
| 熊市后复苏 | 2002-11 → 2007-10 | 底部反弹，房市泡沫积累，S&P500 五年涨幅 +100% |
| 金融危机 | 2007-11 → 2009-03 | 雷曼破产，S&P500 峰谷跌幅 −57%，VIX 峰值 > 80 |
| QE驱动慢牛 | 2009-04 → 2020-01 | 美联储宽松周期，十一年长牛，低波动，强趋势 |
| COVID崩盘+复苏 | 2020-02 → 2021-12 | 疫情急跌（−34%）后 V 形反弹，波动率极高 |
| 加息熊市 | 2022-01 → 2022-09 | 股债双杀，SPY 年化 −31%（前三季度）|
| AI驱动牛市 | 2023-01 → 回测结束 | ChatGPT 引爆 AI 主题，科技股集中领涨 |
""")
...
移动止盈机制在趋势反转初期有效截断了亏损，令策略1.0在峰谷完整的系统性崩盘中
...
已持仓通过移动止盈及时减仓，最大回撤控制在 **{hike_strat_dd*100:.1f}%**，
远低于 SPY 同期最大回撤 **{hike_spy_dd*100:.1f}%**。
