...
def main():
    ...
    if args.run in ("a", "both"):
        ...
        # Read existing meta so all hand-curated UI fields (subtitle, color, etf_universe, etc.) are preserved.
        ...
        if _meta_path.exists():
            try:
                ...
                pass
        # Overlay only the values the backtest actually knows about; keep everything else.
        _existing_meta.update({
            "backtest_start":  args.start,
            "backtest_end":    args.end,
            "initial_capital": args.initial_capital,
            "universe_total":  len(universe),
            "universe_stocks": len([t for t in universe if t not in (getattr(BASE_PARAMS, "etf_universe_set", set()))]),
