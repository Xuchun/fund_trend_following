...
from data.universe import ETF_TICKERS, fetch_sp500_tickers, fetch_sp400_tickers, fetch_sp900_tickers
...
BASELINE_PARAMS = StrategyParams(
    ...
    breakout_strength_min    = 0.0,    # disabled; set > 0 to require minimum breakout margin
    gap_filter          = 0.025,
    commission_bps      = 3.0,
    slippage_bps        = 10.0,
